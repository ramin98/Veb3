...
// console.log(typeof arr, typeof func, typeof obj,typeof name)
...
//             throw new Error("Bu sinifdan obyekt yaratmaq olmaz"); // Bu sınıfdan obyekt yaratmaq mümkün deyil
//         }
//         this.name = name;
//     }
//     // Abstract method
//     sound() {
//         return "Hav hav"; // Köpəyin səsi    
//     }
// }

// // "Dog" sinifi "Animal" sinifini genişlədir
...
// Təkrar "Animal" obyektini yaratmağa çalışdığınızda xəta alacaqsınız
// const creature = new Animal("Creature");  // Xəta: Bu sinifdan obyekt yaratmaq olmaz
...
// // Добавляем метод к прототипу Parent
...
//     Parent.call(this, name); // Вызываем конструктор Parent в контексте Child
//     this.age = age;
// }

// // Наследуем методы и свойства Parent через прототип
// Child.prototype = Object.create(Parent.prototype);

// // Устанавливаем конструктор Child правильно после перезаписи прототипа
...
// child.sayName(); // Name: Alice
// child.sayAge(); // Age: 10

// let array = [1,2,3,4,5]
// Array.prototype.myArrayMethodMult = function (arg) {
//     let arr = []
//     for (let index = 0; index < this.length; index++) {
//         const element = this[index] * arg
//         arr.push(element)
//     }
//     return arr
// }

// let arr = array.myArrayMethodMult(2)
// console.log(arr)
...
//     init() {
//         while (true) {
//             const userInput = prompt("emrleri daxil edin ve ya cixin : \n1) create name \n2) rename id name \n3) remove id \n4) getAllUsersString");
//             if (!userInput) {
//                 break;
//             }
//             const   choice = userInput.split(' ');
//             if (choice[0] === 'create') {
//                 this.usersList.addUser(choice[1]);
//                 console.log(this.usersList.getAllUsersString());
//             } else if (choice[0] === 'rename') {
//                 this.usersList.renameUser(+choice[1], choice[2]);
//                 console.log(this.usersList.getAllUsersString());
//             } else if (choice[0] === 'remove') {
//                 this.usersList.removeUser(+choice[1]);
//                 console.log(this.usersList.getAllUsersString());
//             } else if (choice[0] === 'getAllUsersString') {
//                 console.log(this.usersList.getAllUsersString());
//                 break
//             } else {
